...
export default function AiLearningPage() {
  return <>
    <PageHero variant="gandhi-ref" content={{ eyebrow: "કમ્પ્યુટર આધારિત શીખણ", title: "ભવિષ્ય કુશળતા, સરળ રીતે.", description: "આ પૃષ્ઠ AI લર્નિંગ ને ઉંમર અનુસાર ડિજિટલ તૈયારી તરીકે રજૂ કરે છે: કમ્પ્યુટર, દૃશ્ય શીખણ, જવાબદાર ટેક ટેવો, ક્વિઝ અને માર્ગદર્શિત વર્ગખંડ પ્રોજેક્ટ્સ.", imageSrc: placeholderAssets.computer, imageAlt: "પ્લેસહોલ્ડર: કમ્પ્યુટર શીખણ", primaryCta: { label: "અભ્યાસક્રમ જુઓ", href: "/academics" }, secondaryCta: { label: "એડમિશન", href: "/admissions" } }} />
