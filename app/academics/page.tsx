...
export default function AcademicsPage() {
  return <>
    ...
    <CTASection variant="gandhi-ref" title="ક્લાસ ઉપલબ્ધતા વિશે પૂછો." description="અંતિમ પ્રકાશન પહેલાં ધોરણોની શ્રેણી અને Admissions વિગતો શાળા કચેરી સાથે પુષ્ટિ કરવી." primary={{ label: "Admissions પ્રક્રિયા", href: "/admissions" }} secondary={{ label: "સંપર્ક", href: "/contact" }} />
  </>;
}
