...
export default function ContactPage() {
  return <>
    <PageHero variant="gandhi-ref" content={{ eyebrow: "સંપર્ક", title: "મુલાકાત કરો, પૂછો, પુષ્ટિ કરો.", description: "Admissions માર્ગદર્શન, ક્લાસ ઉપલબ્ધતા, મુલાકાત સમય અને અધિકૃત માહિતી માટે શાળા કચેરીનો સંપર્ક કરો.", imageSrc: placeholderAssets.contact, imageAlt: "પ્લેસહોલ્ડર: શાળાનો બહારનો દ્રશ્ય", primaryCta: { label: "Admissions પૂછપરછ", href: "/admissions" }, secondaryCta: { label: "અભ્યાસક્રમ", href: "/academics" } }} />
    ...
    <CTASection variant="gandhi-ref" title="મુલાકાત પહેલાં વિગતો પુષ્ટિ કરો." description="ફોન, ઇમેઇલ અને સમય જેવી વિગતો અધિકૃત માહિતી મળ્યા સુધી સંપાદિત કરી શકાય તેવા પ્લેસહોલ્ડર છે." primary={{ label: "Admissions", href: "/admissions" }} secondary={{ label: "મુખ્ય પૃષ્ઠ", href: "/" }} />
  </>;
}
