...
export default function ActivitiesPage() {
  return <>
    <PageHero variant="gandhi-ref" content={{ eyebrow: "પ્રવૃત્તિઓ", title: "નાની ક્રિયાઓ. લાંબો આત્મવિશ્વાસ.", description: "પ્રવૃત્તિઓથી વિદ્યાર્થીઓ બોલે, રમે, સહકાર આપે, ઉજવે અને પાઠ્યપુસ્તક બહાર પણ વિકસે છે.", imageSrc: placeholderAssets.playground, imageAlt: "પ્લેસહોલ્ડર: મેદાન", primaryCta: { label: "Admissions", href: "/admissions" }, secondaryCta: { label: "સંપર્ક", href: "/contact" } }} />
