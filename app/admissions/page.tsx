...
export const metadata = createPageMetadata({ title: "Admissions | K.M. Gandhi Primary School", description: "K.M. Gandhi Primary School, વ્યારા માટે Admissions પૂછપરછ અને પ્રક્રિયા માર્ગદર્શન.", path: "/admissions" });
...
export default function AdmissionsPage() {
  return <>
    <PageHero variant="gandhi-ref" content={{ eyebrow: "Admissions", title: "પરિવારો માટે સ્પષ્ટ માર્ગ.", description: "વિનંતીથી શરૂઆત કરો, ક્લાસ ઉપલબ્ધતા પુષ્ટિ કરો, શાળાની મુલાકાત લો અને કચેરી સાથે દસ્તાવેજ પ્રક્રિયા પૂર્ણ કરો.", imageSrc: placeholderAssets.values, imageAlt: "પ્લેસહોલ્ડર: Admissions", primaryCta: { label: "હવે સંપર્ક કરો", href: "/contact" }, secondaryCta: { label: "અભ્યાસક્રમ", href: "/academics" } }} />
    <section className="section-pad" id="process"><p className="eyebrow">પ્રક્રિયા</p><h1 className="editorial-title mt-4">Admissions માટે ચાર સરળ પગલાં.</h1><div className="mt-10 grid gap-4 md:grid-cols-4">{steps.map((x,i)=><article className="paper-card" key={x}><p className="text-xs font-black text-[var(--gold-dark)]">0{i+1}</p><h3 className="mt-3 text-2xl font-black">{x}</h3><p className="mt-3 text-sm font-semibold leading-6 text-[var(--muted)]">કચેરી માર્ગદર્શિત પગલું. અંતિમ લખાણ પ્રકાશિત કરતાં પહેલાં વિગતો પુષ્ટિ કરવી.</p></article>)}</div></section>
    ...
    <section className="section-tight grid gap-8 lg:grid-cols-[.8fr_1.2fr]" id="faq"><div><p className="eyebrow">FAQ</p><h2 className="editorial-title mt-4">Admissions સંબંધિત પ્રશ્નો.</h2></div><div className="grid gap-3">{[["શું Admissions ખુલ્લાં છે?", "હાલની બેઠકો/સીટ ઉપલબ્ધતા માટે સંપર્ક પૃષ્ઠથી પુષ્ટિ કરો."], ["કયા ધોરણો ઉપલબ્ધ છે?", "ધોરણોની શ્રેણી શાળા કચેરી પુષ્ટિ પછી અંતિમ કરવી."], ["શું આ ગુજરાતી માધ્યમ છે?", "જાહેર સ્ત્રોતોમાં શાળાનું માધ્યમ ગુજરાતી દર્શાવવામાં આવ્યું છે."], ["શું સંપર્ક મૂલ્ય અધિકૃત છે?", "અધિકૃત પુષ્ટિ થાય ત્યાં સુધી આ મૂલ્યો પ્લેસહોલ્ડર છે."]].map(([q,a])=><details className="faq-item" key={q}><summary>{q}</summary><p>{a}</p></details>)}</div></section>
